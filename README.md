...
**Étape 2**: Être sur la branche *~/Projet_01-Objets_Intelligents 3* et executer cette commande pour publier sur le topic *sudo python src/publisher_sensor.py*.<br>
